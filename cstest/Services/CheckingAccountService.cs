...
{
    public class CheckingAccountService : IAccountOperation
    {
        private readonly IAccountRepo _accountRepo;
        private readonly ITransactionRepo _transactionRepo;
        private readonly ApplicationDbContext _context;
        private readonly ILogger<CheckingAccountService> _logger;

        public CheckingAccountService(IAccountRepo accountRepo, ITransactionRepo transactionRepo, ApplicationDbContext context, ILogger<CheckingAccountService> logger)
        {
