...
namespace cstest.Controllers
{
    ...
    [ApiController]
    public class CheckingAccountOperationController : ControllerBase
    {
        private readonly IAccountOperation _accountOperation;
        public CheckingAccountOperationController(Func<String, IAccountOperation> accountOperation)
        {
            _accountOperation = accountOperation("checking");
        }
        [HttpPost("deposit")]
